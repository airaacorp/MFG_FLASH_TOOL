                                    ...
                                    Rectangle{
                                        ...
                                        ColumnLayout{
                                            ...
                                            Row{
                                                ...
                                                Rectangle {
                                                    id: customToolTip1
                                                    visible: portNameTextField.focus
                                                    color: "transparent"
                                                    border.color: "transparent"
                                                    radius: 4
                                                    //anchors.right: portNameTextField.right
                                                    //anchors.rightMargin: 0
                                                    Text {
                                                        text: "     Port Numbers must contain at least
                                                    ...
                                                    Timer {
                                                        id: tooltipTimer
                                                        interval: 1000 // 1000 ms delay
                                                        repeat: false
                                                        onTriggered: portNameTextField.tooltipVisible = true
                                                    }
                                                }
                                            ...
                                            Row{
                                                ...
                                                Rectangle {
                                                    id: customToolTip
                                                    visible:baudRateTextField.focus
                                                    color: "transparent"
                                                    border.color: "transparent"
                                                    radius: 4
                                                    // anchors.left: baudRateTextField.right
                                                    // anchors.leftMargin: 5
                                                    // anchors.verticalCenter: baudRateTextField.verticalCenter
                                                    anchors.right: baudRateTextField.right
                                                    anchors.rightMargin: 0

                                                    Text {
                                                        text: "   Frequency must contain Numbers (0-9)"
                                                        color: "#F8F8FF"
                                                        // font.pointSize: 13
                                                        wrapMode: Text.Wrap
                                                    }
                                                    Timer {
                                                        ...
                                                        interval: 1000 // 1000 ms delay
                                                        repeat: false
                                                        onTriggered: baudRateTextField.tooltipVisible = true
                                                    }
